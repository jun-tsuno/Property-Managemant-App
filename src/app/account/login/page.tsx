  ...
  return (
    <div className="py-10 px-5 flex flex-col md:flex-row md:justify-center">
      <div className="py-10 shadow-zinc-500 shadow-md bg-zinc-50 rounded-md px-3 w-[80%] h-full max-w-[500px] mx-auto text-center">
        ...
        <form className="flex flex-col py-10 w-[90%] max-w-[400px] mx-auto" onSubmit={handleSubmit(onSubmit)}>
          <div className="py-3">
            <Controller
              name="email"
              control={control}
            ...
            {errors?.email?.type === 'required' ||
              (errors?.email?.type === 'pattern' && <p className="font-bold text-red-500">Invalid Adress</p>)}
          </div>
          <div className="py-3">
            <Controller
              name="password"
      ...
      <div className="my-8 w-[80%] aspect-square mx-auto relative md:max-w-[500px]">
        <Image src={'/image/login.png'} alt="signup" fill sizes="100%" priority={true} className="object-cover" />
      </div>
    </div>
  );
};

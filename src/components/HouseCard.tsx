	...
	return (
		<div className="m-3 mx-auto">
			<Link href={`/dashboard/${house?.houseId}`}>
				<div className="w-80 aspect-square rounded-2xl bg-[url('/image/house1.png')] bg-cover bg-center relative hover:brightness-110 cursor-pointer hover:-translate-y-2 shadow-zinc-500 shadow-md">
